          ...
          <div className="relative md:grid md:grid-cols-2 md:gap-12">
            ...
            {experiences.map((exp, index) => (
              <motion.div
                ...
                className={`md:col-start-${index % 2 === 0 ? 2 : 1} ${index % 2 !== 0 ? 'md:text-right' : ''} mb-12 md:mb-0`}
              >
                 <div className="p-6 bg-surface border border-border/50 rounded-2xl w-full relative">
                    ...
                    <div className="hidden md:flex items-center justify-center absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2">
                      <div className={`absolute ${index % 2 === 0 ? '-left-[3.1rem]' : '-right-[3.1rem]'} top-1/2 -translate-y-1/2`}>
                    ...
                    <ul className={`mt-3 space-y-1 list-inside ${index % 2 !== 0 ? 'md:text-right' : 'md:text-left'}`}>
                        {exp.tasks.map(task => (
