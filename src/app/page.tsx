...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center space-y-24 overflow-x-hidden md:space-y-32">
      {/* Hero Section */}
      <HeroHighlight>
      ...
      {/* About Section */}
      <SectionReveal id="about" className="w-full scroll-mt-24">
       ...
       {/* Skills Section */}
      <SectionReveal id="skills" className="w-full scroll-mt-24">
      ...
      {/* Experience Section */}
      <SectionReveal id="experience" className="w-full scroll-mt-24">
        <div className="text-center">
      ...
      {/* Projects Section */}
      <SectionReveal id="projects" className="w-full scroll-mt-24">
        <div className="text-center">
      ...
      {/* Contact Section */}
      <SectionReveal id="contact" className="w-full scroll-mt-24">
